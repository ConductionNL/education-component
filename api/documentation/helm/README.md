# education-component chart

The Helm chart installs education-component and by default the following dependencies using subcharts:
...
```bash
helm repo add education-component https://raw.githubusercontent.com/ConductionNL/education-component/master/api/helm/
helm repo update
```
...
```bash
helm install my-education-component ConductionNL/education-component --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `education-component` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `education-component` |
